<template>
  ...
  <!-- DeepSeek logo (wave mark) -->
  <svg v-else-if="platform === 'deepseek'" :class="sizeClass" viewBox="0 0 24 24" fill="currentColor">
    <path d="M12 3c5.05 0 9 3.43 9 7.8 0 3.34-2.32 6.2-5.6 7.34-.42.15-.69.55-.69 1v1.46c0 .65-.72 1.03-1.25.66l-2.16-1.5a1.8 1.8 0 0 0-1.03-.32C6.16 19.44 3 16.08 3 11.94 3 6.95 7.04 3 12 3Zm3.95 6.15c-1.72 0-2.96.73-4.1 1.56-1.03.74-1.97 1.39-3.2 1.39-.82 0-1.58-.3-2.26-.9a.74.74 0 0 0-1.06.08.77.77 0 0 0 .08 1.08c.96.85 2.06 1.27 3.24 1.27 1.73 0 2.97-.74 4.11-1.56 1.02-.74 1.96-1.39 3.19-1.39.8 0 1.56.3 2.27.9a.74.74 0 0 0 1.05-.09.77.77 0 0 0-.09-1.08c-.99-.84-2.08-1.26-3.23-1.26Z" />
  </svg>
